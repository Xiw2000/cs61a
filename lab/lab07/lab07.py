...
def inc_subseqs(s):
    ...
    return subseq_helper(s, 0) #no negative elements
...
def make_glookup(class_assignments):
    ...
    def glookup(assignment, grade):
        nonlocal current_grade, current_total
        current_grade += grade
...
def make_advanced_counter_maker():
    ...
    def advanced_counter_maker():
        local_count = 0
        def advanced_counter(counter_type):
            nonlocal global_count, local_count
            "*** YOUR CODE HERE ***"
            if counter_type == "count":
                local_count += 1
                return local_count
            elif counter_type == "global-count":
                global_count += 1
                return global_count
            elif counter_type == "reset":
                local_count = 0
            elif counter_type == "global-reset":
                global_count = 0
            else:
