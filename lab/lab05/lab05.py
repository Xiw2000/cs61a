...
def add_trees(t1, t2):
    ...
    if is_leaf(t1):
      ...
      son_t1 = fewer_branches + [tree(0) for i in range(len(more_branches)-len(fewer_branches))]
      son_t2 = more_branches
      return tree(label(t1)+label(t2), [add_trees(i1, i2) for i1, i2 in zip(son_t1, son_t2)])
